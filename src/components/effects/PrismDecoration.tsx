...
export default function PrismDecoration({ className = '', size = 320 }: PrismDecorationProps) {
  return (
    ...
    >
      ...
      />
      {/* Inner light rays */}
      <line x1="160" y1="20" x2="100" y2="280" stroke="#00A3CC" strokeWidth="1" opacity="0.4" />
      <line x1="160" y1="20" x2="160" y2="280" stroke="#00A3CC" strokeWidth="1" opacity="0.5" />
      <line x1="160" y1="20" x2="220" y2="280" stroke="#00A3CC" strokeWidth="1" opacity="0.4" />
      ...
      <line x1="117" y1="140" x2="203" y2="140" stroke="#00A3CC" strokeWidth="0.75" opacity="0.35" />
      <line x1="104" y1="180" x2="216" y2="180" stroke="#00D4FF" strokeWidth="0.75" opacity="0.25" />
      <line x1="130" y1="100" x2="190" y2="100" stroke="#00A3CC" strokeWidth="0.75" opacity="0.25" />
      {/* Inner triangle */}
      <polygon
